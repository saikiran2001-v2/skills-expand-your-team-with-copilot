document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      if (currentDifficulty === "") {
        // "All" selected: show every activity regardless of difficulty
      } else {
        // A specific level selected: only show activities with that level
  ...
  function renderActivityCard(name, details) {
    ...
    const difficultyBadgeHtml = details.difficulty_level
      ? `<span class="difficulty-badge difficulty-${details.difficulty_level.toLowerCase()}">${details.difficulty_level}</span>`
      : "";
